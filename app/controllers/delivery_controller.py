"""Controller HTTP de regras de entrega e retirada por empresa."""
...
from app.services.delivery import GetDeliveryOptionsService
...
def simulate():
    ...
    try:
        options = GetDeliveryOptionsService().execute(
            current_company_id(),
            city=data.get("city"),
...
class DeliveryController:
    """Handlers HTTP do dominio de entrega."""
    ...
    pickup = staticmethod(pickup)
    simulate = staticmethod(simulate)


for _endpoint, _handler in {
    "index": DeliveryController.index,
    "create": DeliveryController.create,
    "update": DeliveryController.update,
    "delete": DeliveryController.delete,
    "toggle": DeliveryController.toggle,
    "pickup": DeliveryController.pickup,
    "simulate": DeliveryController.simulate,
}.items():
